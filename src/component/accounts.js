...
import { getTopAccounts } from "../services/api.accounts";
const Accounts = () => {
                  ...
                  <p className="mb-2 mb-md-0">
                    {/* <span className="d-flex align-items-center">
                      <i
                        ...
                        style={{ display: "none" }}
                      />
                      More than &gt; 71,115,461 transactions found
                    </span> */}
                    ...
                    <ul className="pagination pagination-sm mb-0">
                      ...
                      <li className="page-item disabled">
                        <span className="page-link text-nowrap">
                          ...
                          of{" "}
                          <strong className="font-weight-medium">10000</strong>
                        </span>
                      </li>
                      <li
                        className="page-item"
                      ...
                      <li className="page-item">
                        <a className="page-link" href={`${config.baseUrl}txs`}>
                  ...
                  <table className="table table-hover">
                    <thead className="thead-light">
                      <tr>
                        ...
                        <th scope="col">
                          <i className="fa fa-angle-down text-secondary" />{" "}
                          Balance
                        </th>
                      </tr>
                    </thead>
                ...
                >
                  <div className="col d-none d-lg-block">
                    <img
                      ...
                      src="images/svg/bg/bg1-left-side26e8.svg?v=20.4.3.0"
                      alt
                    />
                  </div>
                  ...
                  <div className="col d-none d-lg-block">
                    <img
                      className="img-fluid mx-4"
                      src="images/svg/bg/bg1-right-side26e8.svg?v=20.4.3.0"
                      alt
                    />
                  </div>
                </div>
                    ...
                    <div className="d-md-flex justify-content-between my-3">
                      ...
                      <ul className="pagination pagination-sm mb-0">
                        ...
                        <li className="page-item disabled">
                          <span className="page-link text-nowrap">
                            Page{" "}
                            <strong className="font-weight-medium">1</strong> of{" "}
