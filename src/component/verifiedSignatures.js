...
<div className="wrapper">
  ...
  <main id="content" role="main">
    ...
    <input type="hidden" name="hdnTxnFeeTitle" id="hdnTxnFeeTitle" defaultValue="(Gas Price * Gas Used by Txns) in CCC" />
            ...
            <div id="verifiedSignatures" className="tab-pane active" role="tabpanel" aria-labelledby="verifiedSignaturesTab">
              ...
              <div id="ContentPlaceHolder1_pageRecords">
                <form method="post" action="#" id="ctl00">
                  ...
                  <div className="aspNetHidden">
                    <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" defaultValue="EEB59793" />
                    <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" defaultValue="KdV3TCn534883ccAEEvx/ziY2mDExzXy3CdJLSR2hKQwokvF4RtpnK5grb8LZ3vshF5lt+1p1joRAK26yMDDSZUadoPu7sn9hp92I6PrNd6tJSAr6PN3hZhpsSk+AORPJSDP7fQVsatQyHQsuROijNPOL9ce3KVrBThyk8Nzd1banOHazNKTvOv6F1dMrYzA1q85meK/wHe5HmLBYfHhFg==" />
                  </div>
