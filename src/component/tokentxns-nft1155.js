        ...
        <div className="mb-3 mb-lg-0">
          <h1 className="h4 mb-0">
            ...
            <span id="ContentPlaceHolder1_copyButtonPanel" className="d-inline-flex">
              ...
              <span><a target="_blank" data-toggle="tooltip" title="Click to view address on 3 other chains." className="ml-1 btn btn-sm btn-icon" href="#"><img className="img-fluid rounded-circle" src="images/brands/blockscan-simple.svg" /><span className="badge badge-sm badge-primary badge-pos rounded-circle">3</span></a></span>
            </span>
          </h1>
          <div className="mt-1">
          </div>
                        ...
                        <div className="js-sCCCllbar overflow-hidden pl-2 pr-3" style={{"max-height":"280px"}}>
                          ...
                          <ul className="list list-unstyled mb-0">
                            ...
                            <li className="list-custom list-custom-ERC-20">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="busy?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
                            ...
                            <li className="list-custom">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="token/0xf004d2f46e177ec8ffc7c7c7f2623e212b450920da8a.html?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
                            ...
                            <li className="list-custom">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="token/0xe3402e65311b06b2bd5b0a7e0aae0f378ecd93d8da8a.html?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
                            ...
                            <li className="list-custom">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="token/0xd961956b319a10cbdf89409c0ae7059788a4dabbda8a.html?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
                            ...
                            <li className="list-custom">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="token/0x1e7ec91be2063b002689f2357e356dfb4a40c3c5da8a.html?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
                            ...
                            <li className="list-custom">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="token/0xd083bc9b977f0964a71b62341dc0d34045f18488da8a.html?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
                            ...
                            <li className="list-custom">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="token/0x30ab0d8c808ec024365d45a105c559bdf06bcb14da8a.html?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
                            ...
                            <li className="list-custom">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="token/0xf884647dfa84696d9373f36ee413ccc48093f924da8a.html?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
                            ...
                            <li className="list-custom">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="token/0x70c6062100b09af2ec63345cda372d52423be4acda8a.html?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
                            ...
                            <li className="list-custom">
                              <a className="link-hover d-flex justify-content-between align-items-center" href="token/0x562f021423d75a1636db5be1c4d99bc005ccebfeda8a.html?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">
                                <div>
          ...
          <div className="card h-100">
            ...
            <div className="card-header d-flex justify-content-between align-items-center">
              ...
              <div id="ContentPlaceHolder1_moreoptionsdiv" className="d-flex">
                ...
                <div className="ml-auto mr-1">
                  <span data-toggle="tooltip" data-placement="top" data-title="Add Address to Watch List"><a className="btn btn-xs btn-icon btn-soft-info" href="busy?cmd=addnew&a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923#add"><i className="fa fa-heart btn-icon__inner" /></a></span>
                </div>
                <div className="position-relative">
                  ...
                  <div id="dropdownTools-2" className="dropdown-menu dropdown-menu-right dropdown-unfold" aria-labelledby="dropdownToolsInvoker-2" style={{"z-index":"1021"}}>
                    ...
                    <a className="dropdown-item" href="busy?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923"><i className="fa fa-fw fa-history  mr-1" />Check Previous Balance</a>
                    <hr className="my-1" />
            ...
            <div className="tab-pane fade show active" id="transactions" role="tabpanel" aria-labelledby="transactions-tab">
              ...
              <div className="d-md-flex align-items-center mb-3">
                <p className="mr-2 mb-2">
                  <i className="fas fa-sort-amount-down text-secondary" data-toggle="tooltip" title="Oldest First" />&nbsp;Latest 25 from a total of  <a href="busy?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923" data-toggle="tooltip" title="Click to view full list">3,905</a> transactions
                </p>
                {/* Reset Filters */}
                ...
                <table className="table table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><i className="far fa-file-alt text-secondary" data-toggle="tooltip" data-placement="bottom" title="Contract" /> <a className="hash-tag text-truncate" href={`${config.baseUrl}address`} data-toggle="tooltip" data-placement="bottom" title="0x869820d415721a867f3932af65c09e4b52d0c4a3">0x869820d415721a867f3932af65c09e4b52d0c4a3</a></td>
                      <td>0 CCC</td>
                    ...
                    <tr>
                      ...
                      <td><span className="hash-tag text-truncate" data-toggle="tooltip" data-placement="bottom" title="0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">0x01f4eed3e0297b0cc0363d0f3db49780f41b8923</span></td>
                      <td><span className="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">OUT</span></td>
                      <td><i className="far fa-file-alt text-secondary" data-toggle="tooltip" data-placement="bottom" title="Contract" /> <a className="hash-tag text-truncate" href={`${config.baseUrl}address`} data-toggle="tooltip" data-placement="bottom" title="0x40cbf9c75a46b147e0fd9ab47df5e064ae015f92">0x40cbf9c75a46b147e0fd9ab47df5e064ae015f92</a></td>
                      <td>299 CCC</td>
            ...
            <div className="tab-pane fade" id="internaltx" role="tabpanel" aria-labelledby="internaltx-tab">
              ...
              <div className="d-md-flex justify-content-between mb-4">
                ...
                <nav aria-label="page navigation">
                  <a id="ContentPlaceHolder1_linkShowMoreInternalTx" title="View All Internal Transactions" className="btn btn-xss btn-primary" data-toggle="tooltip" data-toggle-second="tooltip" href="busy?a=0x01f4eed3e0297b0cc0363d0f3db49780f41b8923">View All</a>
                </nav>
                {/* End Pagination */}
              </div>
              {/* End Pagination & more */}
...
export default Tokentxnsnft1155;