      ...
      <div className="py-4">
        <form method="post" action="#" id="ctl00" className="js-validate">
          ...
          <div className="text-md-right">
            <input type="submit" name="ctl00$ContentPlaceHolder1$btnSubmit" defaultValue="Compile Vyper" onclick="var isValid = validatecheck(''); if (isValid) {var $btn = $('#spinwheel'); $btn.show(); window.location.hash = '#'; buttonclicked = true;};" id="ContentPlaceHolder1_btnSubmit" className="btn btn-sm btn-primary mr-2" />
            <input type="reset" name="ctl00$ContentPlaceHolder1$btnReset" defaultValue="Reset" id="ContentPlaceHolder1_btnReset" className="btn btn-sm btn-soft-secondary" formNoValidate="formnovalidate" />
          </div>
