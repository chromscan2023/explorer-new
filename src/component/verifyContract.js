        ...
        <div className="border-top py-4">
          ...
          <div className="w-md-75 w-lg-50 mx-md-auto mt-2">
            ...
            <p align="center" className="mt-3">
              ...
              <input type="submit" name="ctl00$ContentPlaceHolder1$btnSubmit" defaultValue="Continue" onclick="var isValid = validatecheck(); if (isValid) {buttonclicked = true;};" id="ContentPlaceHolder1_btnSubmit" className="btn btn-primary mr-2" />
              <input type="submit" name="ctl00$ContentPlaceHolder1$btnReset" defaultValue="Reset" id="ContentPlaceHolder1_btnReset" formNoValidate="formnovalidate" className="btn btn-soft-secondary" />
            </p>
          </div>
